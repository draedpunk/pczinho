...
// ** Usage: Instantiate script by calling: var uniquevar=createsoundbite("soundfile1", "fallbackfile2", "fallbacksound3", etc)
...
document.getElementById('send-space').addEventListener('mouseover', function() {
    mouseoversound.playclip();
});
document.getElementById('send-space').addEventListener('click', function() {
    clicksound.playclip();
});
